<?php
	...
	$consulta = mysql_query("select * from t_servicios where ");	
?>
						...
						<div class="12u">
							...
							<!-- Form -->
								<section class="box">
									...
									<form method="post" name="myform" action="BorrarService_ok.php" onsubmit="return validacionBorrarServicio(this)">
